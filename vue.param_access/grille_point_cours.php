 ...
 <b class="col-lg-12 col-sm-12 pull-left"> IDENTITE DE L'ENSEIGNANT(E)</b>
    ...
    <table class="table table-bordered table-striped table-condensed">
            ...
            <thead>
                ...
                <?php
                    $dv = new crs_devoirs();
                    $dv = $dv->selectionnerByIdCours($_GET['idCours'])->fetchAll();
        ...
        <tbody>
                <?php
                    ...
                    $grd_tour_remis = $grd_tour_remis ->RemisEleveCours($_GET['idCours']);
                    $cpt=0;
                     foreach($grd_tour_remis  as $sel_grd_tour_remis){
                        $cpt++;
                        echo '<tr>';
                            echo '<td style="color:red">'.$cpt.'</td><td>'.$sel_grd_tour_remis['nomUtilisateur'].' '.$sel_grd_tour_remis['postnomUtilisateur'].' '.$sel_grd_tour_remis['prenomUtilisateur'].'</td>';
