...
?>
                ...
                <center style="font-size:20px;" class="col-sm-12">FORMULAIRE D'INSCRIPTION</center>
                    ...
                    <center style="font-size:20px; " class="col-sm-12">LISTE DES CLASSES FREQUANTEES</center>
                    <div style="margin:10px" class="row">
                       <a style="padding-top:10px" class="col-sm-8" > A ETAIT INSCRIT COMME ELEVE</a><input  id="" type="text" class="form-control col-sm-3 " style="width:150px;"  placeholder="RECH PAR PROMOTION">
                    </div>
                    <div id="" style="padding:0px">
                        <?php
