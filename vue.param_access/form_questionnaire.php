<div role="" enctype="" class="" style="width:100%;margin:1px" id="utilisa">
    ...
    <div class="form-group text-align: center;" style="width:80%; height:80%; margin:10%" id="lcons">
        ...
        ?>
        <center style="width:100%; height:30px; font-size:18px;text-align:center;margin-bottom:20px;margin-top:20px;border-bottom: 1px solid black;">
        ...
        ?>
            ...
            <div class="col-sm-12">
                ...
                <input type="button" onclick="Orientation('../control.param_access/ctr_questionnaire.php?n=<?= $nub ?>&form=<?= 'QuestT' . $nub ?>&idPond=<?= 'pond' . $nub ?>&AjoutQstTr&idDev='+$('#idDev').val()+'&modifQst='+$('#modifQst'+<?= $nub ?>).val()+'&pond='+$('#pond'+<?= $nub ?>).val(),'#<?= 'QuestT' . $nub ?>','#<?= 'QuestT' . $nub ?>');
                 " class="btn btn-xs btn-success pull-right  col-sm-2 col-lg-2 col-xs-2" value="Valider Question :<?= $nub ?>" />
        ...
        ?>
            ...
            <div id="<?= 'QuestC' . $nub ?>" name=<?= 'QuestC' . $nub ?> class="col-sm-12  " style="border: 2px dashed rgba(174, 174, 174, 0.4) margin:botton:15px">
                ...
                +'&asCk6='+$('#asCk6'+<?= $nub ?>).val()
                +'&ass6='+$('#ass6'+<?= $nub ?>).val()
                +'&idDev='+$('#idDev').val(),'#<?= 'QuestC' . $nub ?>','#<?= 'fseria' . $nub ?>')" class="btn btn-success pull-right  col-sm-2 col-lg-2 col-xs-2" value="Valider_Question :<?= $nub ?>" />
            </div>
    </div>
