...
<div class="col-sm-12 row">
    ...
    <div class="col-sm-5" style="padding:0px; margin:0px">
        <center style="font-size:20px;" class="col-sm-12">FORMULAIRE D'AFFECTATION ENSEIGNANT</center>

        <form id="frm_affect" name="frm_affect" style="padding:10px;margin:10px">
            <?php
            include_once("liste_classe_Aff.php");
            ?>
        </form>
    </div>
    <div class="col-sm-2">
        <button class="btn btn-success col-sm-12" style="height:30px; margin-top:50%" onclick='Orientation("../control.param_access/ctr_groupe.php?changeGP=true&idutil=<?= $util["idUtilisateur"] ?>","#editLeco","#frm_grp"); Orientation2("../control.param_access/ctr_enseignant.php?Valide=true&idutil=<?= $_GET["idutil"] ?>","#editLeco","#frm_affect")'><span class="glyphicon glyphicon-share-alt"></span></button>
        <input class="btn btn-default col-sm-12" style="height:30px; margin-top:10%" type="button" onclick='Orientation("../control.param_access/ctr_enseignant.php?annul=true&idutil=<?= $_GET["idutil"] ?>","#editLeco")' value="Annuler">
    </div>

    <div class="col-sm-5" style="padding:0px">
        <center style="font-size:20px; " class="col-sm-12">LISTE DE CLASSES AFFECTE</center>
        <div id="" style="padding:10px;margin:10px">
            <?php
            include_once("classe_Affect.php");
            ?>
        </div>
    </div>
</div>