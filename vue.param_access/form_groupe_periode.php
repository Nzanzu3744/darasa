...
<div class="form-inline col-sm-3" style="height:600px" >
    <div class="form-group well" style="height:600px">              
                ...
                <input style="width:100%" id="gr_p2" type="txt" class="form-control" placeholder="Libelle ex: SEMESTRE">
                <label for="fre47" class=" col-sm-12">Frequence </label>
                <input style="width:100%" id="fre47" type="mail" class="form-control" placeholder="Frequence Ex: 3">
